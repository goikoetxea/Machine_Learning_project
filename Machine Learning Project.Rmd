...
###Conclusion
Random Forest algorithm has better accuracy than Decision Trees. Accuracy for Decision Tree is 0.7436 while accuracy for Random Forest is 0.9946 Therefore, the Random Forest model is chosen. With such a high accuracy, we can expect a very good classification of the 20 test samples. 
